...
class VGG(nn.Module):
    ...
    def __init__(self, features, num_classes=10, use_cos=False, cos_temp=8):
        ...
        self.cos_classifier = classifier.Classifier(512, num_classes, cos_temp)
         # Initialize weights
...
def vgg16(**kwargs):
    ...
    return VGG(make_layers(cfg['D'], batch_norm=False),**kwargs)


def vgg19(**kwargs):
    """VGG 19-layer model (configuration 'E') with batch normalization"""
    return VGG(make_layers(cfg['E'], batch_norm=False),**kwargs)
...
#     )
#     if use_cos:
#         net.classifier[-1] = classifier.Classifier(4096, num_classes, cos_temp)
