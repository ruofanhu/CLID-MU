...
def train(epoch,net,net2,optimizer,optimizer_vnet,labeled_trainloader,unlabeled_trainloader,vnet,meta_loader,args):
    ...
    for batch_idx, (inputs_x, inputs_x2, labels_x, w_x) in enumerate(labeled_trainloader):      
        ...
        Lx = torch.sum(cost[:batch_size*2] * torch.squeeze(v_lambda_norm[:batch_size*2]))
...
stats_log=open(f'/home/rhu/r_work/VRI/VRI_DivideMix/checkpoint/wnet_{args.dataset}_{args.r}_{args.noise_mode}_warm_up{args.warmup}_{args.lambda_u}_stats_{formatted_time}.txt','w')
test_log=open(f'/home/rhu/r_work/VRI/VRI_DivideMix/checkpoint/wnet_{args.dataset}_{args.r}_{args.noise_mode}_warmup{args.warmup}_{args.lambda_u}_acc_{formatted_time}.txt','w')
