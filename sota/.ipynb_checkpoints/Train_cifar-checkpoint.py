...
# Training
def train(epoch,net,net2,optimizer,labeled_trainloader,unlabeled_trainloader, args,meta_loader=None):
    net.train()
    ...
    for batch_idx, (inputs_x, inputs_x2, labels_x, w_x) in enumerate(labeled_trainloader):      
        ...
        if meta_loader is not None:
            net = vri(net, vnet,optimizer, optimizer_vnet,input_a, target_a, metaloader=meta_loader,args)
...
def vri(net, vnet, optimizer, optimizer_vnet,image, labels, metaloader,args):
...
stats_log=open('/home/rhu/r_work/VRI/VRI_DivideMix/checkpoint/%s_%.1f_%s'%(args.dataset,args.r,args.noise_mode)+'_stats.txt','w')
test_log=open('/home/rhu/r_work/VRI/VRI_DivideMix/checkpoint/%s_%.1f_%s'%(args.dataset,args.r,args.noise_mode)+'_acc.txt','w')
...
for epoch in range(args.num_epochs):   
    ...
    if epoch<warm_up:       
        ...
        train(epoch,net1,net2,optimizer1, labeled_trainloader, unlabeled_trainloader, meta_loader=first_meta,args) # train net1
