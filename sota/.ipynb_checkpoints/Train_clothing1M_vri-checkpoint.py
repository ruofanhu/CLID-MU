...
log=open(f'/home/rhu/r_work/VRI/VRI_DivideMix/checkpoint/clithin1m_{args.model}_{args.meta_goal}_{args.meta_lr}_{args.tau}_{formatted_time}_{args.warmup}.txt','w')
log.flush()
