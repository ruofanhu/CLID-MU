...
def train(epoch,net,net2,optimizer,optimizer_vnet,labeled_trainloader,unlabeled_trainloader,vnet,meta_loader,args):
    ...
    for batch_idx, (inputs_x, inputs_x2, labels_x, w_x) in enumerate(labeled_trainloader):      
        ...
        Lx, Lu, lamb = criterion(logits_x, mixed_target[:batch_size*2], logits_u, mixed_target[batch_size*2:],t, args.warmup)
...
stats_log=open(f'/home/rhu/r_work/VRI/VRI_DivideMix/checkpoint/{args.dataset}_{args.r}_{args.noise_mode}_warm_up{args.warmup}_{args.lambda_u}_stats_plain{formatted_time}.txt','w')
test_log=open(f'/home/rhu/r_work/VRI/VRI_DivideMix/checkpoint/{args.dataset}_{args.r}_{args.noise_mode}_warmup{args.warmup}_{args.lambda_u}_acc_plain_{formatted_time}.txt','w')
...
sch_lr_1 = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer1, T_max=300, eta_min=1e-3) 
sch_lr_2 = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer2, T_max=300, eta_min=1e-3) 
