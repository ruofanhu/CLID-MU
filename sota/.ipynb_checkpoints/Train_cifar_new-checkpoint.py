...
def train(epoch,net,net2,optimizer,labeled_trainloader,unlabeled_trainloader,vnet, optimizer_vnet,meta_loader,args):
    net.train()
    ...
    for batch_idx, (inputs_x, inputs_x2, labels_x, w_x) in enumerate(labeled_trainloader):      
        ...
        loss.backward()
        optimizer.step()
        net, vnet = vri_whole(net, vnet,optimizer, optimizer_vnet,mixed_input, mixed_target, meta_loader,args)
...
def vri_whole(net, vnet, optimizer, optimizer_vnet,image, labels, metaloader,args):
        labels_one = torch.argmax(labels, dim=1)

        targets_onehot = torch.nn.functional.one_hot(labels_one, args.num_class).float().cuda()
        ...
        with torch.no_grad():
            dict0 = {'feature': feat_f.detach(), 'target': labels}
...
stats_log=open(f'/home/rhu/r_work/VRI/VRI_DivideMix/checkpoint/sep_{args.dataset}_{args.r}_{args.noise_mode}_warm_up{args.warmup}_{args.lambda_u}_stats_{formatted_time}.txt','w')
test_log=open(f'/home/rhu/r_work/VRI/VRI_DivideMix/checkpoint/sep_{args.dataset}_{args.r}_{args.noise_mode}_warmup{args.warmup}_{args.lambda_u}_acc_{formatted_time}.txt','w')
...
for epoch in range(args.num_epochs):   
    ...
    if epoch<args.warmup:       
        ...
        train(epoch,net1,net2,optimizer1, labeled_trainloader, unlabeled_trainloader, vnet1,optimizer_vnet1,first_meta,args) # train net1
        ...
        train(epoch,net2,net1,optimizer2,labeled_trainloader, unlabeled_trainloader,vnet2, optimizer_vnet2,second_meta,args) # train net2
