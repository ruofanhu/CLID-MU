...
scheduler2 = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer2, T_max=args.num_epochs,eta_min=0.0001, last_epoch=-1)
...
for epoch in range(args.num_epochs+args.warmup):   
    ...
    if epoch<args.warmup:
        ...
        if args.meta_goal!='ce_sloss':
            ...
            meta_loader_2 = eval_train(net2, train_loader)
