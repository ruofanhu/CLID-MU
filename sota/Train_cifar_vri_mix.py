...
stats_log=open(f'./checkpoint/{args.dataset}_{args.r}_{args.noise_mode}_warm_up{args.warmup}_{args.lambda_u}_stats_mix_cos{formatted_time}.txt','w')
test_log=open(f'./checkpoint/{args.dataset}_{args.r}_{args.noise_mode}_warmup{args.warmup}_{args.lambda_u}_acc_mix_cos_{formatted_time}.txt','w')
