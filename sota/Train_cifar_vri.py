...
stats_log=open(f'./checkpoint/{args.dataset}_{args.r}_{args.noise_mode}_warm_up{args.warmup}_{args.lambda_u}_stats_{formatted_time}.txt','w')
test_log=open(f'./checkpoint/{args.dataset}_{args.r}_{args.noise_mode}_warmup{args.warmup}_{args.lambda_u}_acc_{formatted_time}.txt','w')
