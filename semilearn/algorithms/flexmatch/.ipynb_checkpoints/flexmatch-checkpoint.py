...
from semilearn.algorithms.utils import ce_loss, consistency_loss, SSL_Argument, str2bool, mixup_one_target
...
class FlexMatch(AlgorithmBase):
    ...
    def __init__(self, args, net_builder, tb_log=None, logger=None):
        ...
        self.init(T=args.T, p_cutoff=args.p_cutoff, hard_label=args.hard_label, thresh_warmup=args.thresh_warmup,mixup_alpha=args.mixup_alpha)
    
    def init(self, T, p_cutoff, hard_label=True, thresh_warmup=True,mixup_alpha=1):
        self.T = T
