...
cfg_name=b_${alg}_cifar10_resnet34_${label_amount}_lr${lr}_True_bsz128_${noise_type}_${noise_ratio}_False_1000_100_${meta_loss}_uni_${meta_lr}_beta0_${seed}.yaml
