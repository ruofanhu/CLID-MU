...
cfg_name=b_${th}_${alg}_cifar100_wrn_28_8_${label_amount}_lr0.03_True_bsz100_${noise_type}_${noise_ratio}_False_1000_500_${meta_loss}_uni_${meta_lr}_beta0_${seed}.yaml
