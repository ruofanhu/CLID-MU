...
gamma=${13:-1}
w_nege=${14:-0}
python main_vri.py --corruption_type=${corruption_type} --corruption_prob=${corruption_prob} --lr=${lr} --meta_lr=${meta_lr} --tau=${tau} --dataset=${dataset} --gpuid 0 --seed=${seed} --meta_bsz=${meta_bsz} --meta_goal=${meta_goal} --Tmax=${Tmax} --w_cov=${w_cov} --w_svd=${w_svd} --gamma=${gamma} --w_nege=${w_nege}