...
class Dividemix_lossnet(AlgorithmBase):
    """
    ...
    def train_step(self, idx_lb,x_lb, y_lb,y_true, idx_e, x_e_w, x_e_s, y_e_true):
    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            ...
            for data_lb in self.loader_dict['train_lb']:
                ...
                self.tb_dict,self.tb_meta, self.log = self.train_step(**self.process_batch(data_eval,**data_lb))
