    ...
    def __call__(self, features):
        ...
        if 'label' in batch:
            if 'true_label' in batch:
                return {'idx_lb': batch['idx'], 'text':text_, 'x_lb': {'input_ids': batch['input_ids'], 'attention_mask': batch['attention_mask']}, 'y_lb': batch['label'],'y_true': batch['true_label']}
                
            else:
                return {'idx_lb': batch['idx'], 'text':text_, 'x_lb': {'input_ids': batch['input_ids'], 'attention_mask': batch['attention_mask']}, 'y_lb': batch['label']}
